...
export const translations = {
  en: {
    ...
    bio: {
      label: "Bio",
      p1: "Designing precise interfaces and digital products — craft as a discipline, not a shortcut.",
      p2: "Design Manager at Mercado Pago, leading by doing — close to the work, growing teams that ship.",
      p3a: "Founder of",
      p3b: " — a studio using AI as a creative material for branding and generative design.",
      cta: "Get in touch",
    },
  ...
  pt: {
    ...
    bio: {
      label: "Bio",
      p1: "Criando interfaces precisas e produtos digitais — craft como disciplina, não como atalho.",
      p2: "Design Manager no Mercado Pago, liderando fazendo — perto do trabalho, desenvolvendo times que entregam.",
      p3a: "Fundador da",
      p3b: " — um estúdio que usa IA como material criativo para branding e design generativo.",
